...
import com.sunseed.exceptions.InvalidEnumValueException;
...
public class EnumDeserializer<T extends Enum<T>> extends StdDeserializer<T> {
	...
	public T deserialize(JsonParser parser, DeserializationContext context) throws IOException {
		...
		throw new InvalidEnumValueException(null, enumClass.getSimpleName(), "invalid.enum");
	}

	@Override
	public T getNullValue(DeserializationContext ctxt) {
		throw new InvalidEnumValueException(null, enumClass.getSimpleName(), "enum.not.found");
	}
}
